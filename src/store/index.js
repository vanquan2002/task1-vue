...
export default new Vuex.Store({
  ...
  getters: {
    ...
    getTotalQualityProductCart(state) {
      return state.totalQuality;
    },
  },
  mutations: {
    ...
    updateCartAndLocalStorage(state) {
      ...
      this.commit("setTotalQualityProductCart");
    },
    ...
    setTotalQualityProductCart(state) {
      state.totalQuality = 0;
      state.listProductCart.forEach((item) => {
        state.totalQuality += item.quality;
      });
    },
  },
  actions: {
